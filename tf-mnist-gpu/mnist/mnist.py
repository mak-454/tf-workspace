...
import os
DATA_DIR=os.getenv('TF_TRAINING_DATA_DIR', '/tmp/mnist_data')
MODEL_DIR=os.getenv('TF_MODEL_DIR', '/tmp/mnist_model')
EXPORT_DIR=os.getenv('TF_EXPORT_DIR', '/tmp/trained_model')
